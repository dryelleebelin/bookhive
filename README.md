...
## 💡 Problema
Encontrar livros relevantes de forma simples e agradável pode ser difícil. Plataformas genéricas não oferecem experiência personalizada, e pequenos vendedores têm dificuldade em criar interfaces modernas sem backend complexo.
...
```bash
# Clone o repositório:
git clone https://github.com/dryelleebelin/bookhive.git
